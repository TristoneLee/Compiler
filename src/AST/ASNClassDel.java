...
public class ASNClassDel extends ASNStmt {
    ...
    public void build() throws CompileException {
        for (ASN child : children) {
            if (child instanceof ASNClassConstructorDec) {
                if (!Objects.equals(((ASNClassConstructorDec) child).className, classEntity.className))
                    throw new InvalidStmt();
                constructorDec = (ASNClassConstructorDec) child;
                classEntity.classConstructor=((ASNClassConstructorDec) child).entity;
            } else if (child instanceof ASNFuncDec) {
    ...
    public void check() throws CompileException {
        if (constructorDec != null && !Objects.equals(constructorDec.className, classEntity.className))
            throw new CompileException("UnmatchedConstructor");
